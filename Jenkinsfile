        ...
        stage('Run playbook') {
            ...
            steps {
                script {
                    ...
                    dir('ansible-codes') {
                        sh 'ansible-vault decrypt inventory.yml --vault-password-file /home/ec2-user/ansible-dev/workspace/week16-project/ansible-codes/abc123.txt'
                        sh 'ansible-inventory -i home/ec2-user/ansible-dev/workspace/week16-project/ansible-codes/inventory.yml --list'
